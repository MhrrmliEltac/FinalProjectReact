...
const UserNavbar = () => {
  ...
  const { username } = nameLocation.state || {};
  ...
  const handleClickShowPanel = () => {
    setShowState((prevState) => !prevState);
  };
      ...
      <div className="container-fluid header">
        ...
        >
          ...
          <form className="d-flex form" role="search">
            ...
            <div onClick={handleClickShowPanel} className="profile">
              <i className="fa-solid fa-user"></i>
              <p className="user-name">{username}</p>
              {showState && (
                <div className="panel">
                  <span className="panel-user">{username}</span>
                  <button onClick={handleClickExit} className="exit-btn">
                    Exit
                  </button>
                </div>
              )}
